...
// (generated by durable-gen) instead of raw DurableCallJSON / DurableCall calls.
...
import (
	...
	"github.com/rcownie/durable/examples/fooddash/clients/dispatch"
	"github.com/rcownie/durable/examples/fooddash/clients/menu"
	"github.com/rcownie/durable/examples/fooddash/clients/payments"
	"github.com/rcownie/durable/examples/fooddash/clients/restaurant"
)

// PlaceOrderTyped demonstrates the PlaceOrder workflow using typed service clients.
func PlaceOrderTyped(h durable.HostCalls, userID string, restaurantID string,
	...
	_, err = durable.PollUntil(h, 30*time.Second, 30*time.Minute,
		func() (string, error) {
