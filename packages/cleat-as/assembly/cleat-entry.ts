...
export function cleatEntry(name: string = ""): (target: usize, propertyKey: string, descriptor: usize) => void {
  return function (
    _target: usize,
    _propertyKey: string,
    _descriptor: usize,
 ...
 * @cleatEntry transform-generated wrapper detects it and returns
 ...
 *   let result = host.cleatCall("payment", "charge", `{"amount": 100}`);
 *   if (result.isError) {
