...
def _import_schedule_cron(
    ...
    """
    raise NotImplementedError(_NO_WIT_BINDING.format(name="schedule_cron"))
...
def _import_delete_cron(
    ...
    """
    raise NotImplementedError(_NO_WIT_BINDING.format(name="delete_cron"))
...
def _import_list_crons(
    ...
    """
    raise NotImplementedError(_NO_WIT_BINDING.format(name="list_crons"))
