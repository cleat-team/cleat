...
def _assert_analyze(
    tmp_path, source: str, expected_code: str, filename: str = "test.py"
) -> None:
    ...
    assert expected_code in codes, (
        f"Expected {expected_code!r} in errors, got {codes}"
    )


def _assert_no_error(
    tmp_path, source: str, code: str, filename: str = "test.py"
) -> None:
    ...
    assert code not in codes, (
        f"Did not expect {code!r} in errors, got {codes}"
    )
