...
//     engine/rust_defer_segment_e2e_test.go, same measurement against the real
//     cargo build (3.107).
...
var deferSegmentLanguages = map[string]bool{"go": true, "java": true, "rust": true, "assemblyscript": true}
