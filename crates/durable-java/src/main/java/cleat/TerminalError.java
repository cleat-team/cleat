 ...
 * Go's {@code durable.TerminalError} sentinel and the AS
 * {@code TERMINAL_ERROR_CODE} constant.
 * <p>
 * Usage in a workflow entry point:
 * <pre>{@code
 * @DurableEntry(name = "process_payment")
 ...
 * }</pre>
 * <p>
 * When the annotation processor ({@link DurableEntryProcessor}) encounters a
