...
/**
 * A simple result type for cleat durable workflow operations.
 ...
 */
public class DurableResult<T> {

    private final T value;
    private final String error;

    private DurableResult(T value, String error) {
        this.value = value;
        this.error = error;
    }
     ...
     * @return a new {@code DurableResult} representing success
     */
    public static <T> DurableResult<T> ok(T value) {
        return new DurableResult<>(value, null);
    }
     ...
     * @return a new {@code DurableResult} representing failure
     */
    public static <T> DurableResult<T> err(String error) {
        return new DurableResult<>(null, error);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DurableResult)) return false;
        DurableResult<?> that = (DurableResult<?>) o;
