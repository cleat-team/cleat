 ...
 * defined in {@code crates/durable-sdk/src/memory.rs} and {@code ABI.md}.
 * <p>
 * <h3>Memory Layout</h3>
 * <pre>
 * Offset         | Size    | Use
...
public final class Memory {
    ...
    /**
     * Decode the response length from a {@code durable_call} result
     * (bits 40-63).
     */
    ...
    /**
     * Decode the call error code from a {@code durable_call} result
     * (bits 8-39).
     */
    ...
    /**
     * Decode the top-level errCode from a {@code durable_call} result
    ...
    /**
     * Decode the sleep duration from a {@code durable_sleep} result
     * (bits 0-55).
     */
    ...
    /**
     * Decode the sleep status from a {@code durable_sleep} result
     * (bits 56-63).
     *
    ...
    /**
     * Decode the signal name length from {@code durable_await_signals}
     * (bits 48-63).
     */
    ...
    /**
     * Decode the payload length from {@code durable_await_signals}
     * (bits 32-47).
     */
    ...
    /**
     * Decode the timedOut flag from {@code durable_await_signals}
     * (bits 16-31).
     *
    ...
    /**
     * Decode the error code from {@code durable_await_signals}
     * (bits 0-15).
     */
    ...
    /**
     * Decode the payload length from {@code durable_poll_signal}
     * (bits 32-63).
     */
    ...
    /**
     * Decode the found flag from {@code durable_poll_signal}
    ...
    /**
     * Decode the error code from {@code durable_poll_signal}
     * (bits 0-7).
     */
    ...
    /**
     * Decode the cancelled flag from {@code durable_poll_cancellation}
     ...
     * {@code durable_poll_cancellation} (bits 32-63).
     */
