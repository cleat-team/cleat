...
#
# THIS FIXTURE PINS A LIMIT THE DOCUMENTATION ALREADY STATES, which is the
# strongest position a known-limit fixture can be in. LANGUAGE_SUPPORT.md's
# per-language enforcement table says the Python checker cannot see
#
#     "a forbidden call spelled so the (module, function) table does not match it"
#
# This file is the executable form of that sentence. The doc can now only stop
# being true by turning this red.
#
