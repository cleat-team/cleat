...
var adapterDefs = map[string]adapterDef{
	"DurableCall": {
		...
		ResultStmts: []string{
			...
			`		Operation: operation,`,
			`		Code:      callErrorCode,`,
			`		Message:   fmt.Sprintf("cleat_call: error %d (0=unknown 1=timeout 2=transient 3=not_found 4=invalid 5=permission_denied)", errCode),`,
			`	}`,
			"}",
	...
	"PollChild": {
		...
		ResultStmts: []string{
			...
			"}",
			"var pr struct { Status string `json:\"status\"`; Result string `json:\"result,omitempty\"`; Error string `json:\"error,omitempty\"` }",
	...
	"AwaitAnyChild": {
		...
		ResultStmts: []string{
			...
			"}",
			"var out struct { RunID string `json:\"run_id\"`; Result string `json:\"result,omitempty\"`; Error string `json:\"error,omitempty\"` }",
	...
	"DurableCallWithRetry": {
		...
		ResultStmts: []string{
			...
			`		Operation: operation,`,
			`		Code:      callErrorCode,`,
			`		Message:   fmt.Sprintf("cleat_call_retry: error %d (0=unknown 1=timeout 2=transient 3=not_found 4=invalid 5=permission_denied)", errCode),`,
			`	}`,
			"}",
			"return unsafe.String(&responseBuf[0], int(responseLen)), nil",
		},
	...
	"DurableCallWithHeartbeat": {
		...
		ResultStmts: []string{
			...
			`		Operation: operation,`,
			`		Code:      callErrorCode,`,
			`		Message:   fmt.Sprintf("cleat_call_heartbeat: error %d (0=unknown 1=timeout 2=transient 3=not_found 4=invalid 5=permission_denied)", errCode),`,
			`	}`,
			"}",
			"return unsafe.String(&responseBuf[0], int(responseLen)), nil",
		},
