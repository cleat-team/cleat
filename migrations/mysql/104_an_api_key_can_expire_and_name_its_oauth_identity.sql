...
-- table's own created_at -- and like created_at, capped at 2038-01-19 (MySQL's
-- TIMESTAMP ceiling; PostgreSQL and SQL Server hold 9999-01-01), so a
-- far-future expiry cannot be represented on this dialect.
--
