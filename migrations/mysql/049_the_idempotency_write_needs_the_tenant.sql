...
-- migrations/mysql/048_a_burst_wakes_finalize_on_progress.sql verbatim. Only the two idempotency_keys predicates change.
...
--
-- Replaces the procedure whole, so this file otherwise reproduces migrations/mysql/046_a_signal_delivered_mid_segment_wakes_the_workflow.sql
